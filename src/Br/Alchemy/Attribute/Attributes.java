...
public enum Attributes {
     ...
     */
    Penetrate("物理穿透", 1, -1, true),
    /**
     * 比例增加伤害 运算在暴击前 负值表示减少造成的伤害
     */
    ATKBoost("攻击增幅", 2, -0.5, true),
    /**
     * 负暴击时造成的伤害是原伤害的 0.5倍
     */
    Crit("暴击率", 1, -1, true),
     ...
     */
    CritExtraDamage("额外暴击伤害", 3, 0, true),
    /**
     * 闪避属性 注意 闪避值不是绝对闪避概率 和绝对闪避概率中存在公式转换待定
     */
    Dodge("闪避", 500, 0, false),
    /**
     * 攻击精准度, 直接参与绝对闪避率计算
     */
    Accuracy("精准", 0.3, -0.25, true),
    Health("生命值", 1000, 0, false),
    /**
     * 计算生命值加成后的百分比转换生命值
     */
    ...
    private Attributes(String defname, double defmax, double defmin, boolean rate) {
